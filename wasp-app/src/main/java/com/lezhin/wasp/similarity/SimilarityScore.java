...
public class SimilarityScore {
    ...
    public static void save(SparkSession spark, Dataset<Row> scoreDf, String locale, String adultKind) {
    ...
    public static void  main(String... args) {
        ...
        try {
            ...
            if (test) {
                queryStr = queryStr + " and content_id <= 4 ";
            }
            ...
            save(spark, scoreDf, locale, adultKind);
